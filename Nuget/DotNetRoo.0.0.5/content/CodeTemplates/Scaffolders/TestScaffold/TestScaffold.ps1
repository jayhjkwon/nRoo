[T4Scaffolding.Scaffolder(Description = "Enter a description of TestScaffold here")][CmdletBinding()]
param(        
    [string]$Project,
	[string]$CodeLanguage,
...
Add-ProjectItemViaTemplate $outputPath -Template TestScaffoldTemplate `
